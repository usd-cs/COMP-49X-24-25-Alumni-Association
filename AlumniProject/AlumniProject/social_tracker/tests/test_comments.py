...
class CommentDataTests(TestCase):
    ...
    def test_get_comments_helper_reply_ids(self, mock_get):
        ...
        comment_obj, reply_ids = get_comments_helper("fake_token", comment_id, post_id=post_id)
    ...
    def test_get_instagram_posts_updates_existing_post(self, mock_get):
        ...
        Post.objects.create(
            ...
            post_API_ID="1",
            num_likes=1, num_comments=1, num_shares=1, num_saves=1,
            date_posted=timezone.now()
        )
